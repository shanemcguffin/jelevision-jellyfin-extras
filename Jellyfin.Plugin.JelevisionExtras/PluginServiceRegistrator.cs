        ...
        IServerApplicationHost applicationHost)
    {
        serviceCollection.AddHttpClient<TheDiscDbClient>(client =>
        {
            ...
            client.DefaultRequestHeaders.UserAgent.ParseAdd(
                "Jelevision-Extras-Enricher/0.3.2 (+https://github.com/TheDiscDb/data)");
        });
        ...
        serviceCollection.AddHttpClient<CommunityCatalogClient>(client =>
        {
            ...
            client.DefaultRequestHeaders.UserAgent.ParseAdd(
                "Jelevision-Extras-Enricher/0.3.2 (+https://github.com/shanemcguffin/jelevision-jellyfin-extras)");
        });
